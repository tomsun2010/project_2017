...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/xbk/mywork/tcl8.6.6/unix -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/opt/tcl/lib -ltcl8.6'
...
# compiled.
TCL_SRC_DIR='/home/xbk/mywork/tcl8.6.6'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/xbk/mywork/tcl8.6.6/unix -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/opt/tcl/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/xbk/mywork/tcl8.6.6/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/opt/tcl/lib/libtclstub8.6.a'
